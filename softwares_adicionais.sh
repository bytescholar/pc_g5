...
sudo apt install -y pdfarranger drawing shotcut obs-studio codeblocks gscan2pdf handbrake neovim converseen virt-manager gnome-video-trimmer video-downloader obfuscate gimp pdfsam
